...
<!-- Page Heading -->
<h1 class="h3 mb-0 text-gray-800 mb-4">Seleksi Jurusan Pilihan 1</h1>
          ...
          data.forEach(r => {
            ...
            <tr class="">
              ...
              <td class="font-weight-bolder">${r.nilai}</td>
                <td>
                  <button type="button" class="btn btn-success btn-sm approve mb-3" data-id_formulir="${r.id}" data-pilihan="1" data-id_jur="${id_jur}"><i class="fas fa-check"></i></button>
