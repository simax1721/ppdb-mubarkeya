...
<img style="width: 100px;" class="" src="{{ url('logomubarkeya.png') }}" alt="">
...
<div class="container">
    ...
    <form method="POST" action="{{ url('admin/login') }}" class="user">
        ...
        <div class="" style="margin-top: 40px">
            ...
            <br> <span style="font-size: 16px; margin-top: 15px;">Back to <a href="{{ url('/') }}" style="color: #bc032f">Home</a></span>
        </div>
