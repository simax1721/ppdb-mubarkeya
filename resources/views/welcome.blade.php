...
@section('hero')
  ...
  <section class="about-lists">
    <div class="container">
      ...
      <div class="section-title">
        <h2>Visi</h2>
        <p class="" style="font-style: italic">"Mewujudkan Generasi SMK Unggul, terampil, berbudaya yang berkarakter edutechnopreuneur islami <br> serta menjunjung tinggi nilai Pancasila dalam menghadapi Era Digital"</p>
      </div>
      <div class="section-title">
        <h2>Misi</h2>
      ...
      <div class="row no-gutters justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" style="border-left: 0px">
          <span>01</span>
          {{-- <h4>Lorem Ipsum</h4> --}}
          <p>Mendidik peserta didik yang beriman dan bertaqwa kepada Tuhan Yang Maha Esa, berakhlak mulia, berkebhinnekaan global, mandiri, bergotong royong, bernalar kritis, kreatif.</p>
        </div>

        <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="100">
          <span>02</span>
          {{-- <h4>Repellat Nihil</h4> --}}
          <p>Menyelenggarakan dan melaksanakan proses pembelajaran yang ditangani langsung oleh tenaga profesional melalui perkembangan teknologi sesuai program keahliannya dengan pendekatan kearifan lokal.</p>
        </div>

        <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="200">
          <span>03</span>
          {{-- <h4> Ad ad velit qui</h4> --}}
          <p>Melatih peserta didik yang berkarakter dan berjiwa wirausaha.</p>
        </div>

        <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="300" style="border-left: 0px">
          <span>04</span>
          {{-- <h4>Repellendus molestiae</h4> --}}
          <p>Menerapkan budaya literasi, penguasaan perkembangan teknologi informasi, dalam memahami keberagaman sosial budaya.</p>
        </div>

        <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="400">
          <span>05</span>
          {{-- <h4>Sapiente Magnam</h4> --}}
          <p>Melatih peserta didik melalui pola kemitraan dengan dunia usaha dan industri menjadi tenaga kerja yang handal serta mampu bersaing secara global.</p>
        </div>
